...
$(document).ready(function () {
    ...
    $('.tz_submit').on('click', function (event) {
        ...
        if (tz_process) 
        {
            ...
            $.post("http://www.themezaa.com/html/leadgen/demo/hosting/js/tz_mail/contact.php", {
    ...
    $('.default-submit').on('click', function (event) {
        ...
        {
            localStorage.setItem('tz_section',section_id);
            $.post("http://www.themezaa.com/html/leadgen/demo/hosting/js/tz_mail/hosting-contact.php", {
                data: {email: email},
                type: "POST",
            }, function (data) {
                $('#loading').remove();
